...
UPDATE_URL="https://github.infpro.me/https://raw.githubusercontent.com/qqrrooty/EZrealm/main/realm.sh"
VERSION_CHECK_URL="https://github.infpro.me/https://raw.githubusercontent.com/qqrrooty/EZrealm/main/version.txt"
...
deploy_realm() {
    ...
    LATEST_VERSION=$(curl -sL https://github.infpro.me/https://github.com/zhboner/realm/releases | grep -oE '/zhboner/realm/releases/tag/v[0-9]+\.[0-9]+\.[0-9]+' | head -n1 | cut -d'/' -f6 | tr -d 'v')
    ...
    # 下载最新版本
    DOWNLOAD_URL="https://github.infpro.me/https://github.com/zhboner/realm/releases/download/v${LATEST_VERSION}/realm-x86_64-unknown-linux-gnu.tar.gz"
